    ...
    <?php else: ?>
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                            ...
                            <div class="p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                                ...
                                <div class="flex items-center justify-between sm:justify-end gap-6 w-full sm:w-auto">
                                    ...
                                    <a href="cart.php?action=remove&product_id=<?php echo $item['product_id']; ?>"
                                        class="p-2 text-slate-400 hover:text-rose-500 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors"
                                        title="Remove Item">
            ...
            <div
                ...
                <a href="checkout.php"
                    class="w-full h-11 flex items-center justify-center bg-indigo-600 hover:bg-indigo-500 dark:bg-indigo-500 dark:hover:bg-indigo-600 text-white font-bold rounded-xl transition-all shadow-md shadow-indigo-500/10 hover:shadow-indigo-500/20 active:scale-[0.99]">
                    Proceed to Checkout
                </a>
